...
contract Pausable is Ownable {
    ...
    //  4) create 'paused' & 'paused' modifier that throws in the appropriate situation
    modifier paused()
    {
        require(_paused == true, "Contract is paused by Owner.");
        _;
    }

        modifier unpaused()
    {
        require(_paused == false, "Contract must be unpaised paused by Owner.");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender, "Must not be same address");
...
contract RealEstate_Token  is ERC721Metadata("Property Asset Token","PAT","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/")  {
